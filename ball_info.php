...
if (isset($_POST['submit'])) {
    ...
    $entry_by = $_POST['entry_by'];
     ...
     echo $sql = "INSERT INTO `ball_dump` (`tornament_id`, `match_id`, `innings`, `boll_Status`, `boll_no`, `over_no`, `wickets_type`, `boller_id`,
        ...
        <section class="maincontent">
            ...
            <form action="" method="post">
                ...
                <select name="boll_no" value="">
                    ...
                    <option value="6">last</option> </select> 
                    ...
                    <select name="wickets_type" value="">
                        ...
                        <option value="RunOut">Run Out</option></select>
                    ...
                    <option value="0">NO</option>
                        ...
                        <option value="6">Six</option> </select>
                       
                        <label for="">Bouncer:</label>
                    <select name="bouncer" value="">
                    <option value="0">NO</option>
                        <option value="1">One Bounce</option> </select>
